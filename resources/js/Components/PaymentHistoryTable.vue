            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                    <table class="min-w-full leading-normal">
                        ...
                        <tbody>
                            <tr v-for="payment in $page.props.orders">
                                <td class="cursor-pointer px-5 py-5 border-b border-gray-200 bg-white text-sm underline hover:text-blue-500">
                                    ...
                                    <!-- <button type="button" @click="fetchToken(payment.snap_token)" class="cursor-pointer inline-block px-6 py-2.5 bg-blue-800 text-white font-medium text-xs leading-tight uppercase rounded shadow-lg hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Check Kode</button> -->
                                </td>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">
                                        {{ change(payment.created_at) }}
                                    </p>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-blue-500 underline cursor-pointer">
